    ...
    <div className="min-h-screen bg-secondary p-8 font-inter text-foreground">
      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-2xl shadow-sm border border-input">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>Welcome to RIT Library Print. By using our website and services, you agree to comply with the following Terms and Conditions of use.</p>
          <ul className="list-disc pl-6 space-y-2 mt-4">
            <li>The content of the pages of this website is for your general information and use only.</li>
            <li>Users are strictly prohibited from uploading illicit, copyrighted, or globally restricted documents for printing. RIT Library Print and the RIT Library desk refuse responsibility for the legality of user-uploaded copyright documents.</li>

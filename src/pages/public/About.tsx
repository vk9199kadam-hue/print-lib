    ...
    <div className="min-h-screen bg-secondary p-8 font-inter text-foreground">
      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-2xl shadow-sm border border-input">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>Welcome to RIT Library Print.</p>
          ...
          <p>Through RIT Library Print, you can seamlessly upload documents, select precisely how you want them printed, and submit them directly. Your print orders are instantly sent to the library desk for processing.</p>
